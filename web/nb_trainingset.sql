...
--
-- Table structure for table `nb_trainingset`
--

CREATE TABLE `nb_trainingset` (
  `document` text NOT NULL,
  `category` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `nb_trainingset`
--

INSERT INTO `nb_trainingset` (`document`, `category`) VALUES
